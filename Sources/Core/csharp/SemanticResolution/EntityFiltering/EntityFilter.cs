    ...
    public class EntityFilter
    {
        ...
        public static void FilterGeographic( ref XElement xmlText )
        {
            if ( _geoNames == null )
            {
                try
                {
                    _geoNames = new HashtableSearcher( Utils.GlobalVariables.UserResourcesPath + _path2GeoDict, HashtableEngineHelper.NormlizeText );
                }
                catch ( DiskSearchEngineException ex )
                {
